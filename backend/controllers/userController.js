...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    const resetPasswordUrl = `${process.env.FRONTEND_URL || `${req.protocol}://${req.get("host")}`}/password/reset/${resetPasswordToken}`;
    ...
    <head>
      <style>
        ...
        .container { max-width: 600px; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); margin: 0 auto; }
        ...
        .button { background-color: #0095f6; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 16px; display: inline-block; }
        .footer { text-align: center; font-size: 12px; color: #999999; border-top: 1px solid #eeeeee; padding-top: 20px; }
      </style>
    </head>
    <body>
      <div class="container">
    ...
    try {
        await sendEmail({
            email: user.email,
            subject: "Instagram Password Reset Request",
            message,
            html: htmlContent
        });
